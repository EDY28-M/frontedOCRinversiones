  ...
  return (
    <div className="inicio-wrapper bg-surface font-sans text-text-main antialiased">
      <div className="relative flex flex-col w-full">
        ...
        {/* ==================== HERO SECTION ==================== */}
        <section className="relative pt-24 h-[85vh] w-full flex items-center justify-center bg-gray-50 hero-section">
          <div 
          ...
          <div className="relative z-10 w-full max-w-[1400px] px-6 md:px-12 grid md:grid-cols-2 gap-12 items-center">
            <div className="text-left">
              <div className="inline-block px-3 py-1 bg-blue-50 border border-blue-100 text-xs font-bold uppercase tracking-wider text-primary mb-6">
                Líderes en Importación
              </div>
              <h1 className="font-display text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-medium uppercase text-black tracking-tight leading-none mb-6">
                Expertos en <br/><span className="text-primary">Repuestos</span> Coreanos, <span className="text-primary">Japoneses</span> y Chinos
              </h1>
              <p className="text-base sm:text-lg text-gray-700 max-w-lg font-normal mb-10 leading-relaxed border-l-4 border-accent pl-6">
                Más de 15 años de experiencia atendiendo talleres y flotas en Ate, Lima. Calidad garantizada para tu motor.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                <button className="bg-accent hover:bg-accent-hover text-black px-8 py-4 font-bold uppercase tracking-wider text-xs transition-colors shadow-lg shadow-yellow-200">
                  Ver Catálogo
                </button>
                <button className="bg-white border border-gray-300 hover:border-primary hover:text-primary text-black px-8 py-4 font-semibold uppercase tracking-wider text-xs transition-colors">
                  Contactar Asesor
                </button>
              </div>
            </div>
        ...
        {/* ==================== PRODUCTS SECTION ==================== */}
        <section className="bg-surface-alt py-24 border-t border-border-light">
          <div className="max-w-[1400px] mx-auto px-6 md:px-12">
            {/* Section Header */}
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end mb-16 gap-4">
              <div>
                <span className="text-primary text-xs font-bold uppercase tracking-widest mb-2 block">Catálogo Online</span>
                <h2 className="font-display text-3xl sm:text-4xl md:text-5xl font-medium uppercase text-black mb-2">Productos Destacados</h2>
              </div>
              <Link className="hidden md:flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-primary hover:text-black transition-colors" to="/productos">
                Ver Catálogo Completo <span className="material-symbols-outlined text-lg">arrow_forward</span>
              </Link>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-8">
              {/* Product 1 */}
              <div className="bg-white border border-gray-200 group grid-card hover:border-primary/30 hover:shadow-xl transition-all duration-300">
                <div className="aspect-[4/3] bg-gray-50 overflow-hidden relative">
                  <div className="absolute top-4 left-4 z-10 bg-primary text-white text-[10px] font-bold px-3 py-1.5 uppercase tracking-wide">Nuevo Ingreso</div>
                  <div 
                ...
                <div className="p-8 product-card-content">
                  <h3 className="font-display text-xl font-medium uppercase text-primary mb-2">Motor Diesel 2.5L Turbo</h3>
                  <p className="text-sm text-gray-500 mb-6 font-light">Compatible con Hyundai H1 / Porter. Rendimiento superior y bajo consumo.</p>
                  <div className="flex items-center justify-between">
                    <button className="w-full bg-accent hover:bg-accent-hover text-black py-3 font-bold uppercase text-xs tracking-wider transition-colors">
                      Cotizar Ahora
                    </button>
                  </div>
                </div>
              ...
              <div className="bg-white border border-gray-200 group grid-card hover:border-primary/30 hover:shadow-xl transition-all duration-300">
                ...
                <div className="p-8 product-card-content">
                  <h3 className="font-display text-xl font-medium uppercase text-primary mb-2">Kit de Reparación Motor</h3>
                  <p className="text-sm text-gray-500 mb-6 font-light">Juego completo de empaques y pistones para motores Isuzu serie N.</p>
                  <div className="flex items-center justify-between">
                    <button className="w-full bg-accent hover:bg-accent-hover text-black py-3 font-bold uppercase text-xs tracking-wider transition-colors">
                      Cotizar Ahora
                    </button>
              ...
              <div className="bg-white border border-gray-200 group grid-card hover:border-primary/30 hover:shadow-xl transition-all duration-300">
                ...
                <div className="p-8 product-card-content">
                  <h3 className="font-display text-xl font-medium uppercase text-primary mb-2">Culata Completa 3.0L</h3>
                  <p className="text-sm text-gray-500 mb-6 font-light">Para Toyota Hilux / Hiace. Material reforzado para trabajo pesado.</p>
                  <div className="flex items-center justify-between">
                    <button className="w-full bg-accent hover:bg-accent-hover text-black py-3 font-bold uppercase text-xs tracking-wider transition-colors">
                      Cotizar Ahora
                    </button>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-8">
              ...
              <div className="bg-white border border-gray-200 group grid-card hover:border-primary/30 hover:shadow-xl transition-all duration-300">
                ...
                <div className="p-8 product-card-content">
                  <h3 className="font-display text-xl font-medium uppercase text-primary mb-2">Set de Filtros Heavy Duty</h3>
                  <p className="text-sm text-gray-500 mb-6 font-light">Aire, Aceite y Combustible. Protección máxima para motores de carga.</p>
                  <div className="flex items-center justify-between">
                    <button className="w-full bg-accent hover:bg-accent-hover text-black py-3 font-bold uppercase text-xs tracking-wider transition-colors">
                      Cotizar Ahora
                    </button>
              ...
              <div className="bg-white border border-gray-200 group grid-card hover:border-primary/30 hover:shadow-xl transition-all duration-300">
                <div className="aspect-[4/3] bg-gray-50 overflow-hidden relative">
                  <div className="absolute top-4 left-4 z-10 bg-accent text-black text-[10px] font-bold px-3 py-1.5 uppercase tracking-wide">Oferta</div>
                  <div 
                    className="w-full h-full bg-cover bg-center card-img transition-transform duration-500"
                    style={{backgroundImage: 'url("https://lh3.googleusercontent.com/aida-public/AB6AXuD6aAXIdmyLI-VmCXw3ei_O2zxFd3rS23EzoNgVy2bM29doMxteKy20xdnHGoyxgk3v6WTCBHQV3_4Qu6wUXCNuEJ_z74Uwou0NfbTNsLj9y7FkqjljGkoy-dD_YFD0VoE3u9sr-5eZig13qFKJlVICqakLnr_XhnClKNmm9NL-ly8QQV2BTpyXoOmegxS1ERjSJGJPJem1L8oO4Q6raqhn4EoVcs7PB0opGaRNkq179ClmDVzPV2UN2S3RQF4EAWBBAVOHnWjPnVQ")'}}
                  ></div>
                ...
                <div className="p-8 product-card-content">
                  <h3 className="font-display text-xl font-medium uppercase text-primary mb-2">Filtro Separador Agua/Comb.</h3>
                  <p className="text-sm text-gray-500 mb-6 font-light">Sistema avanzado de filtración para camiones chinos Sinotruk / Jac.</p>
                  <div className="flex items-center justify-between">
                    <button className="w-full bg-accent hover:bg-accent-hover text-black py-3 font-bold uppercase text-xs tracking-wider transition-colors">
                      Cotizar Ahora
                    </button>
              ...
              <div className="bg-white border border-gray-200 group grid-card hover:border-primary/30 hover:shadow-xl transition-all duration-300">
                ...
                <div className="p-8 product-card-content">
                  <h3 className="font-display text-xl font-medium uppercase text-primary mb-2">Pack Mantenimiento Flota</h3>
                  <p className="text-sm text-gray-500 mb-6 font-light">Kit x10 unidades de filtros de aceite. Precio especial para empresas.</p>
                  <div className="flex items-center justify-between">
                    <button className="w-full bg-accent hover:bg-accent-hover text-black py-3 font-bold uppercase text-xs tracking-wider transition-colors">
                      Cotizar Ahora
                    </button>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-white border border-gray-200 group grid-card hover:border-primary/30 hover:shadow-xl transition-all duration-300">
                ...
                <div className="p-8 product-card-content">
                  <h3 className="font-display text-xl font-medium uppercase text-primary mb-2">Discos de Freno Ventilados</h3>
                  <p className="text-sm text-gray-500 mb-6 font-light">Aleación de alta resistencia térmica para buses interprovinciales.</p>
                  <div className="flex items-center justify-between">
                    <button className="w-full bg-accent hover:bg-accent-hover text-black py-3 font-bold uppercase text-xs tracking-wider transition-colors">
                      Cotizar Ahora
                    </button>
              ...
              <div className="bg-white border border-gray-200 group grid-card hover:border-primary/30 hover:shadow-xl transition-all duration-300">
                ...
                <div className="p-8 product-card-content">
                  <h3 className="font-display text-xl font-medium uppercase text-primary mb-2">Pastillas de Freno Cerámicas</h3>
                  <p className="text-sm text-gray-500 mb-6 font-light">Frenado silencioso y eficaz. Larga duración para uso intensivo.</p>
                  <div className="flex items-center justify-between">
                    <button className="w-full bg-accent hover:bg-accent-hover text-black py-3 font-bold uppercase text-xs tracking-wider transition-colors">
                      Cotizar Ahora
                    </button>
              ...
              <div className="bg-white border border-gray-200 group grid-card hover:border-primary/30 hover:shadow-xl transition-all duration-300">
                ...
                <div className="p-8 product-card-content">
                  <h3 className="font-display text-xl font-medium uppercase text-primary mb-2">Cámaras de Aire (Brake)</h3>
                  <p className="text-sm text-gray-500 mb-6 font-light">Sistemas neumáticos de frenado. Repuestos para camiones americanos.</p>
                  <div className="flex items-center justify-between">
                    <button className="w-full bg-accent hover:bg-accent-hover text-black py-3 font-bold uppercase text-xs tracking-wider transition-colors">
                      Cotizar Ahora
                    </button>
            ...
            <div className="mt-12 text-center md:hidden">
              <button className="bg-white border border-gray-300 text-black px-8 py-3 font-semibold uppercase tracking-wider text-xs w-full">Ver Catálogo Completo</button>
            </div>
          </div>
        </section>
        ...
        <footer className="bg-primary text-white pt-16 pb-8 border-t-4 border-accent">
          <div className="max-w-[1400px] mx-auto px-6 md:px-12">
            <div className="grid md:grid-cols-4 gap-12 mb-16 footer-grid">
              {/* Logo Column */}
              <div className="col-span-1 md:col-span-1">
                <div className="flex items-center gap-2 mb-6">
                  <span className="material-symbols-outlined text-accent text-3xl">settings_b_roll</span>
                  <span className="text-2xl font-display font-bold uppercase tracking-tight text-white">ORC <span className="text-accent text-sm align-middle">Inversiones</span></span>
                </div>
              ...
              {/* Navigation Column */}
              <div>
                <h4 className="font-bold uppercase mb-6 text-xs tracking-widest text-accent">Navegación</h4>
              ...
              {/* Contact Column */}
              <div>
                <h4 className="font-bold uppercase mb-6 text-xs tracking-widest text-accent">Contacto</h4>
                <ul className="space-y-3 text-sm text-blue-100">
              ...
              {/* Newsletter Column */}
              <div>
                <h4 className="font-bold uppercase mb-6 text-xs tracking-widest text-accent">Boletín</h4>
