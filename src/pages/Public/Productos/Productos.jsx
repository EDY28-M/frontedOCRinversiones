...
/**
 * Página Productos - Placeholder
 * TODO: Implementar catálogo completo
 */
      ...
      <div className="relative flex flex-col w-full">
          ...
          <div className="max-w-[1400px] mx-auto px-6 md:px-12">
            <div className="flex items-center justify-between h-24">
              ...
              <nav className="hidden md:flex items-center gap-12">
                ...
                <Link className="text-black hover:text-primary text-sm font-semibold uppercase tracking-widest transition-colors" to="/productos">Productos</Link>
        ...
        <main className="pt-24">
          <section className="py-24 bg-surface-alt">
            <div className="max-w-[1400px] mx-auto px-6 md:px-12">
              <span className="text-primary text-xs font-bold uppercase tracking-widest mb-2 block">Catálogo Completo</span>
              <h1 className="font-display text-4xl md:text-5xl font-medium uppercase text-black mb-8">Productos</h1>
              <p className="text-lg text-gray-600 max-w-2xl">
                Página en construcción. Pronto encontrarás aquí nuestro catálogo completo de repuestos.
              </p>
