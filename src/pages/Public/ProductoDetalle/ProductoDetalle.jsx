            ...
            <div>
              ...
              <section className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start mb-12">
                ...
                <div className="lg:col-span-5 flex flex-col">
                  ...
                  {/* Cantidad + Botón WhatsApp (Comprar por WhatsApp) */}
                  <div className="flex items-center gap-3 mb-6">
                    <div className="flex items-center h-12 border-2 border-primary/40 rounded-full overflow-hidden shrink-0">
                      <button
                        type="button"
                        className="w-11 h-full text-xl font-bold text-gray-700 hover:bg-gray-50 transition-colors"
                    ...
                    <button
                      ...
                      className="flex-1 h-12 rounded-full bg-primary hover:bg-primary-dark text-white font-bold text-sm sm:text-base transition-colors shadow-sm flex items-center justify-center gap-2"
                    >
