...
const WhatsAppButton = () => {
    const phoneNumber = "51984244498"; // Sin el + para el link
    const message = "Hola, necesito más información sobre sus productos y servicios. ¿Podrían ayudarme?";
    ...
    return (
        <div className="fixed bottom-6 right-6 z-50 flex items-center gap-3">
            ...
            <div className="bg-green-600 text-white px-4 py-2 rounded-full shadow-lg flex items-center gap-2 animate-bounce-subtle">
                ...
                <span className="font-semibold text-sm">+51 984 244 498</span>
            </div>
            ...
            >
                ...
                {/* Pulse animation */}
                <span className="absolute w-full h-full bg-green-500 rounded-full animate-ping opacity-30"></span>
            </a>
        </div>
    );
};
