              ...
              <div className="bg-white border border-gray-200 shadow-sm p-8 w-full flex flex-col">
                ...
                <div className="mt-auto">
                  ...
                  <button
                    ...
                    className="w-full bg-[#25D366] hover:bg-[#128C7E] text-white transition-colors font-bold uppercase tracking-wide py-3 px-6 flex justify-center items-center gap-2 rounded-lg"
                  >
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
